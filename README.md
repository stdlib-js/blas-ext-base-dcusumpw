...
```javascript
import dcusumpw from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dcusumpw@v0.2.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-dcusumpw/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/blas-ext-base-dcusumpw/actions/workflows/test.yml?query=branch:v0.2.1
