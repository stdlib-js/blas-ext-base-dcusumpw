...
```javascript
import dcusumpw from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dcusumpw@v0.3.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-dcusumpw/actions/workflows/test.yml/badge.svg?branch=v0.3.0
[test-url]: https://github.com/stdlib-js/blas-ext-base-dcusumpw/actions/workflows/test.yml?query=branch:v0.3.0
