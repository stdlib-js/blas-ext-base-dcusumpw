...
```javascript
dcusumpw = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dcusumpw@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dcusumpw@umd/bundle.js"></script>
```
